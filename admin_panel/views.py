		...
		if 'obn' in request.GET:
			if request.GET['obn'] == "1":
				...
				for sot in Sotrud.objects.all():
					...
					print("ФМО: " + sot.fio)
					print("hir_rinc: " + str(sot_inf["hir_rinc"]))
					print("publ_rinc: " + str(sot_inf["publ_rinc"]))
					print("publ_yrinc: " + str(sot_inf["publ_yrinc"]))
					print("cit_rinc: " + str(sot_inf["cit_rinc"]))

					print("2017_publ_rinc: " + str(sot_inf["2017_publ_rinc"]))
					print("2017_publ_yrinc: " + str(sot_inf["2017_publ_yrinc"]))
					print("2017_cit_rinc: " + str(sot_inf["2017_cit_rinc"]))

					print("2018_publ_rinc: " + str(sot_inf["2018_publ_rinc"]))
					print("2018_publ_yrinc: " + str(sot_inf["2018_publ_yrinc"]))
					print("2018_cit_rinc: " + str(sot_inf["2018_cit_rinc"]))					

					print("2019_publ_rinc: " + str(sot_inf["2019_publ_rinc"]))
					print("2019_publ_yrinc: " + str(sot_inf["2019_publ_yrinc"]))
					print("2019_cit_rinc: " + str(sot_inf["2019_cit_rinc"]))					

					print("2020_publ_rinc: " + str(sot_inf["2020_publ_rinc"]))
					print("2020_publ_yrinc: " + str(sot_inf["2020_publ_yrinc"]))
					print("2020_cit_rinc: " + str(sot_inf["2020_cit_rinc"]))

					print("2021_publ_rinc: " + str(sot_inf["2021_publ_rinc"]))
					print("2021_publ_yrinc: " + str(sot_inf["2021_publ_yrinc"]))
					print("2021_cit_rinc: " + str(sot_inf["2021_cit_rinc"]))					

					print("2022_publ_rinc: " + str(sot_inf["2022_publ_rinc"]))
					print("2022_publ_yrinc: " + str(sot_inf["2022_publ_yrinc"]))
					print("2022_cit_rinc: " + str(sot_inf["2022_cit_rinc"]))						
				dr_close()
